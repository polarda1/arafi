...
\033[0;93m  •••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;92m       RAV \033[0;96m ---- \033[1;93m GANTENG \033[0;96m ---- \033[095m BANGETT 
\033[0;96m [][][][][][][][][][][][][][[]][[]][[]][[]][[]][[]]""""")
id = []
cp = []
ok = []
...
def masuk():
	...
	try:
		...
		if token == "ilhamrmdhan":
			os.system("xdg-open https://www.facebook.com/100009259285042/posts/3032645343720745/?app=fbl")
...
def hamz_bot():
    ...
    kom = " Lo Kontol Bang:v"
    kom2 = " Semoga Bang Rav Langgeng sama @[100000312369376:] Terus ya Amiin 😘"
